...
var DEFAULT_URL = '/js/vendor/pdfjs/web/compressed.tracemonkey-pldi-09.pdf';
...
function configure(PDFJS) {
  ...
  PDFJS.workerSrc = '/js/vendor/pdfjs/build/pdf.worker.js';
  PDFJS.cMapUrl = '/js/vendor/pdfjs/web/cmaps';
