...
import com.jacky.strive.common.entity.CustomDateDeserise;
import com.jacky.strive.common.entity.CustomDateSerise;
import com.jacky.strive.common.entity.SerializeException;
import org.apache.commons.lang3.StringUtils;
import org.apache.commons.lang3.math.NumberUtils;
//import qsq.biz.common.exception.SerializeException;
//import qsq.biz.common.util.date.CustomDateDeserise;
//import qsq.biz.common.util.date.CustomDateSerise;
...
public class JsonUtil {
    ...
    static {
        ...
        //字段为null不显示
        excludeNullMapper.setSerializationInclusion(JsonInclude.Include.NON_NULL);
    }
    ...
    public static String toJson(Object obj, boolean prettyPrinter, boolean excludeNull) {
        ...
        ObjectMapper objectMapper = useAnnotationMapper;
        if (excludeNull) {
    ...
    private static <T> T toObj(String content, TypeReference<T> typeOfT) {
        ...
        try {
            return useAnnotationMapper.readValue(content, typeOfT);
        } catch (Exception ex) {
    ...
    private static <T> T toObj(String content, Class<T> classOfT) {
        ...
        try {
            return useAnnotationMapper.readValue(content, classOfT);
        } catch (Exception ex) {
            throw new SerializeException(String.format("将%s解析为%s出错,%s",
                    content,
                    classOfT.toString(),
    ...
    public static <T> T toObj(String content, Class<?> collectionClass, Class<?>... elementClasses) {
        try {
            return useAnnotationMapper.readValue(content,
                    getCollectionType(useAnnotationMapper, collectionClass, elementClasses));
        } catch (Exception ex) {
    ...
    public static <T> T getAttrFromJson(String jsonString, String attrRoute, String routeSpliter,
        ...
        try {
            if (StringUtils.isEmpty(attrRoute)) {
                ...
                JsonNode jsonNode = useAnnotationMapper.readTree(jsonString);
    ...
    public static <T> T fromXml(String xml, Class<T> clzss) {
        try {
            return xmlMapper.readValue(xml, clzss);
        } catch (Exception e) {
            LogUtil.error(e);
        }
        return null;
